	...
	public void processIncomingVehicle() {
		try {
			...
			if (parkingSpot != null && parkingSpot.getId() > 0) {
				...
				parkingSpotDAO.updateParking(parkingSpot);// allow this parking space and mark it's availability as
															// false
				...
				if (isRecurrentUser) {
					...
					System.out.println("Welcome back! As a recurring user of our parking lot, you'll benefit from a "
							+ Fare.DISCOUNT_RATE_FOR_RECURRENT_USERS + "% discount.");
				} else
					ticket.setDiscountStatus(false);
