...
public class FareCalculatorServiceTest {
	...
	public void calculateFareCarForRecurrentUser() {
		...
		ticket.setOutTime(outTime);
		ticket.setParkingSpot(parkingSpot);
		ticket.setDiscountStatus(true); // Boolean for Recurrent Users is True (there were already a ticket with the
										// Vehicle Number
		fareCalculatorService.calculateFare(ticket);
		assertEquals((12 * Fare.CAR_RATE_PER_HOUR * (1 - (Fare.DISCOUNT_RATE_FOR_RECURRENT_USERS / 100))),
				ticket.getPrice());
	}
